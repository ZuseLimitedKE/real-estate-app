...
interface DepositPropertyTokensProps {
  open: boolean;
  setOpen: (open: boolean) => void;
  onSuccess?: () => void;
}

export default function DepositPropertyTokens({ open, setOpen, onSuccess }: DepositPropertyTokensProps) {
  ...
  useEffect(() => {
    if (deposited) {
      ...
      toast.success("Property Tokens deposited to escrow");
      onSuccess?.();
      setOpen(false);
      // Reset form
      setAmount("");
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Deposit Property Tokens to Escrow</DialogTitle>
          <DialogDescription>
            Approve and deposit tokens into the marketplace escrow to place sell
            orders.
          </DialogDescription>
        </DialogHeader>
