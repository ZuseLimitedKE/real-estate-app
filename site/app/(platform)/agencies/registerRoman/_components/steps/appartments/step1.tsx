import { LocationPicker } from "@/app/(platform)/agencies/_components/location-picker";
        ...
        <section className="space-y-4">
            <div className="space-y-2">
                ...
                {errors.apartment_property_details?.name && (
                    <p className="text-sm text-red-500 mt-1">{errors.apartment_property_details?.name.message}</p>
                )}
            </div>
            ...
            <section className="space-y-2">
                ...
                <LocationPicker
                    onCoordinatesChange={(coords) => {
                        if (coords) {
                            setValue("apartment_property_details.location.coordinates", coords);
                        }
                    }}
                    initialCoordinates={watch("apartment_property_details.location.coordinates")}
                />
            ...
            <div className="space-y-2">
                ...
                <Input
                    ...
                    type="number"
                    {...register("apartment_property_details.floors", { valueAsNumber: true })}
                    placeholder="Enter the number of floors in your appartment"
                />
                {errors.apartment_property_details?.floors && (
                    <p className="text-sm text-red-500 mt-1">{errors.apartment_property_details?.floors.message}</p>
                )}
            </div>
            ...
            <div className="space-y-2">
                ...
                <Input
                    ...
                    type="number"
                    {...register("apartment_property_details.parking_spaces", { valueAsNumber: true })}
                    placeholder="Enter total number of parking spaces in the apartment"
                />
                {errors.apartment_property_details?.parking_spaces && (
                    <p className="text-sm text-red-500 mt-1">{errors.apartment_property_details?.parking_spaces.message}</p>
                )}
            </div>
            ...
            <div className="space-y-2">
                ...
                <Input
                    ...
                    min="0"
                    max="100"
                    {...register("apartment_property_details.serviceFeePercent", { valueAsNumber: true })}
                    placeholder="10"
                />
