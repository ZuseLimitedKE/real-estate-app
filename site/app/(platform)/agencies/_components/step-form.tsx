...
const apartmentSteps: Steps[] = [
  step1,
  {
    ...
    icon: HousePlus,
    fields: [
      "apartment_property_details.name",
      "apartment_property_details.description",
      "apartment_property_details.location",
      "apartment_property_details.parking_spaces",
      "apartment_property_details.serviceFeePercent",
      "apartment_property_details.floors",
    ],
  },
  {
    num: 3,
...
const singlePropertySteps: Steps[] = [
  step1,
  {
    ...
    icon: House,
    fields: [
      "single_property_details.name",
      "single_property_details.description",
      "single_property_details.gross_property_size",
      "single_property_details.amenities",
    ],
  },
  {
    num: 3,
  ...
  },
  {
    ...
    icon: Wallet,
    fields: [
      "single_property_details.proposedRentPerMonth",
      "single_property_details.serviceFeePercent",
      "single_property_details.property_value",
    ],
  },
  {
    num: 6,
...
export const CreatePropertyContext =
  createContext<CreatePropertyContextType | null>(null);
    ...
    return {
      ...
      single_property_details: {
        ...
        property_owners: Array.isArray(
          ...
          ? data?.single_property_details?.property_owners.map(
            (owner: any) => ({
              ...owner,
